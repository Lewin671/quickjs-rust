...
fn evaluates_set_constructor_and_prototype() {
    assert_eval("typeof Set;", Value::String("function".to_owned().into()));
    ...
    assert_eval(
        ...
        Value::String("[object Set]".to_owned().into()),
    );
...
#[test]
fn set_constructor_uses_new_target_realm_default_prototype() {
    assert_eq!(
        eval(
            "let realmPrototype = {}; \
             function C() {} \
             Object.defineProperty(C, '__quickjsRustRealmSetPrototype', { value: realmPrototype }); \
             C.prototype = null; \
             Object.getPrototypeOf(Reflect.construct(Set, [], C)) === realmPrototype;"
        ),
...
fn evaluates_set_iterable_constructor_arguments() {
    assert_eval(
        ...
        Value::String("2:true:true".to_owned().into()),
    );
    assert_eval(
...
fn set_constructor_uses_prototype_add_adder() {
    assert_eval(
        ...
        Value::String("2:a|b|:true:true:true".to_owned().into()),
    );
    assert_eval(
...
fn evaluates_set_composition_methods_with_sets() {
    assert_eval(
        ...
        Value::String("true:3:123".to_owned().into()),
    );
    assert_eval(
        "var result = new Set([1, 2]).union(new Set([2, 3])); [...result].join('|') + ':' + result.size;",
        Value::String("1|2|3:3".to_owned().into()),
    );
    assert_eval(
    ...
    assert_eval(
        ...
        Value::String("2:13".to_owned().into()),
    );
    assert_eval(
        ...
        Value::String("1|2|3:true:false:0".to_owned().into()),
    );
    assert_eval(
        ...
        Value::String("true:false:2;true:false:1;true:false:1|3".to_owned().into()),
    );
    assert_eval(
...
fn evaluates_set_composition_methods_with_set_like_objects() {
    ...
    assert_eval(
        ...
        Value::String("false:true:true".to_owned().into()),
    );
    assert_eval(
        ...
        Value::String("true:a|b".to_owned().into()),
    );
    assert_eval(
    ...
    assert_eval(
        ...
        Value::String("true:3:1|2|0".to_owned().into()),
    );
    assert_eval(
        ...
        Value::String("1|3|4".to_owned().into()),
    );
    assert_eval(
        ...
        Value::String("false:1:1|true:4:0".to_owned().into()),
    );
    assert_eval(
        ...
        Value::String("true:4:0|false:1:1".to_owned().into()),
    );
}
...
fn validates_set_like_size_as_number() {
    assert_eval(
        ...
        Value::String("true:1".to_owned().into()),
    );
    assert!(
        eval(
...
fn evaluates_set_iterators_and_for_each() {
    ...
    assert_eval(
        ...
        Value::String("a:false|b:false|true:true".to_owned().into()),
    );
    assert_eval(
        ...
        Value::String("a:b".to_owned().into()),
    );
    assert_eval(
        ...
        Value::String("a:a|b:b".to_owned().into()),
    );
    assert_eval(
    ...
    assert_eval(
        ...
        Value::String("a|b|a|:2".to_owned().into()),
    );
    assert_eval(
