...
fn evaluates_date_builtins() {
    ...
    assert_eq!(
        ...
        Ok(Value::String(
            "959915045006|2000-06-02T03:04:05.006Z".to_owned()
        ))
    );
    assert_eq!(
        eval(
        ...
        Ok(Value::String("0001-02-03T03:04:05.006Z".to_owned()))
    );
    assert_eq!(
        eval(
        ...
        Ok(Value::String(
            "-62135596800000|0001-01-01T00:00:00.000Z".to_owned()
        ))
    );
    assert_eq!(
    ...
    assert_eq!(
        ...
        Ok(Value::String(
            "5281445006|1970-03-03T03:04:05.006Z".to_owned()
        ))
    );
    assert_eq!(
        eval(
        ...
        Ok(Value::String(
            "2689445006|1970-02-01T03:04:05.006Z".to_owned()
        ))
    );
    assert_eq!(
        eval("var d = new Date('1970-01-31T03:04:05.006Z'); d.setUTCMonth(-1); d.toISOString();"),
        Ok(Value::String("1969-12-31T03:04:05.006Z".to_owned()))
    );
    assert_eq!(
        eval(
    ...
    assert_eq!(
        ...
        Ok(Value::String(
            "11045006|1970-01-01T03:04:05.006Z".to_owned()
        ))
    );
    assert_eq!(
        eval(
    ...
    assert_eq!(
        ...
        Ok(Value::String(
            "-75354994|1969-12-31T03:04:05.006Z".to_owned()
        ))
    );
    assert_eq!(
