...
pub(super) fn call_date_native(
    ...
    let value = match native {
        ...
        NativeFunction::DateParse => date::native_date_parse(argument_values, env)?,
        NativeFunction::DateUtc => date::native_date_utc(argument_values, env)?,
        ...
        NativeFunction::DatePrototypeSetTime => {
            date::native_date_prototype_set_time(this_value, argument_values, env)?
        }
        NativeFunction::DatePrototypeSetUtcDate => {
            date::native_date_prototype_set_utc_date(this_value, argument_values, env)?
        }
        NativeFunction::DatePrototypeSetUtcFullYear => {
            date::native_date_prototype_set_utc_full_year(this_value, argument_values, env)?
        }
        NativeFunction::DatePrototypeSetUtcHours => {
            date::native_date_prototype_set_utc_hours(this_value, argument_values, env)?
        }
        NativeFunction::DatePrototypeSetUtcMilliseconds => {
            date::native_date_prototype_set_utc_milliseconds(this_value, argument_values, env)?
        }
        NativeFunction::DatePrototypeSetUtcMinutes => {
            date::native_date_prototype_set_utc_minutes(this_value, argument_values, env)?
        }
        NativeFunction::DatePrototypeSetUtcMonth => {
            date::native_date_prototype_set_utc_month(this_value, argument_values, env)?
        }
        NativeFunction::DatePrototypeSetUtcSeconds => {
            date::native_date_prototype_set_utc_seconds(this_value, argument_values, env)?
        }
