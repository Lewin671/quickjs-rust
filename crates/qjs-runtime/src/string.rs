...
pub(super) use prototype::{
    ...
    native_string_prototype_last_index_of, native_string_prototype_match,
    native_string_prototype_pad, native_string_prototype_repeat, native_string_prototype_search,
